...
class Updateobservacao(LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        lista = ['1. Faltar à verdade ou omitir deliberadamente informações que possam conduzir à apuração de uma '
                  ...
                  'suas atribuições.8. Deixar de comunicar a tempo, ao superior imediato, ocorrência no âmbito de suas '
                  ...
                  'gestos ou palavras, mesmo entre civis.101. Ofender a moral, os costumes ou as instituições '
                  'nacionais ou do país estrangeiro em que se encontrar, por atos, gestos ou palavras',
    ...
    def form_valid(self, form):
        if form.instance.tipo == 'negativa' and form.instance.solucao == 'Advertência de Caráter Reservado':
            ...
            form.instance.pontos = int(-10)
        elif form.instance.tipo == 'positiva' and form.instance.solucao == 'Dispensa Parcial do Serviço':
            form.instance.pontos = 2
        elif form.instance.tipo == 'positiva' and form.instance.solucao == 'Dispensa Total do Serviço':
            form.instance.pontos = 3
        elif form.instance.tipo == 'positiva' and form.instance.solucao == 'Referência Elogiosa':
            form.instance.pontos = 5
        elif form.instance.tipo == 'positiva' and form.instance.solucao == 'Elogio':
            form.instance.pontos = 10
        elif form.instance.tipo == 'neutra':
            form.instance.pontos = int(-1)
        form.save()
        return super().form_valid(form)
